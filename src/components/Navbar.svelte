...
<nav class="w-auto h-20 inset-x-6 top-6 px-4 fixed bg-white rounded-lg shadow">
    ...
    <div class="h-full float-right flex items-center justify-center py-4">
      <!--
      <button type="button" class="mr-1 text-gray-700 hover:bg-gray-100 h-full rounded-lg text-lg font-medium px-5 py-2.5 text-center">Home</button>
...
<!--
  <img class="float-left h-full" src="/guns-n-goose/static/logo-text.svg" alt="logo">
  <div class="float-right w-auto h-full py-4">
    <div class="h-full m-auto float-left">29897249₴</div>
    <img class="h-full rounded-xl" src="https://avatars.dicebear.com/api/adventurer-neutral/{$user}.svg" alt="user">
  </div>
...
<nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded">
  ...
  <a href="/" class="flex items-center">
      <img src="guns-n-goose/static/logo-text.svg" class="mr-3 h-6 sm:h-10" alt="Guns N' Goose Logo" />
  </a>
